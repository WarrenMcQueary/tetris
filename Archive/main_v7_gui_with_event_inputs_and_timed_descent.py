...
def create_piece(pieces):
    ...
    grid[0:2, math.floor(len(grid[0]) / 2) - 2:math.floor(len(grid[0]) / 2) + 2] = grid[0:2, math.floor(len(grid[0]) / 2) - 2:math.floor(len(grid[0]) / 2) + 2] + piece     # TODO: Change to += piece for concision.
...
def take_input():
    ...
    """
    # TODO: This function might become unnecessary.
    global grid
...
def game_loop():
    """Main game loop."""
    # TODO: This function might become unnecessary, unless we use it to periodically call descend_piece().
    global grid     # TODO: Remove unused globals.
    global possible_pieces
    global score
    global cell_size
    global step_time
...
#game_canvas.after(500, game_loop)  # TODO: This line might become unnecessary.
